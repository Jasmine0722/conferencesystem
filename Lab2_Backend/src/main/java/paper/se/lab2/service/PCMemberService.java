package paper.se.lab2.service;

import paper.se.lab2.controller.request.AddCommentRequest;
...
import paper.se.lab2.repository.*;
...
//        String pathName = "/usr/local/paper/" + paper.getConferenceFullname() + "/" + paper.getFilename();//you should use this line if the backend runs on dcloud
         String pathName = "K:/桌面/zuoye/"+paper.getConferenceFullname()+"/"+paper.getFilename();//you should use this line and choose a path if the backend runs locally
